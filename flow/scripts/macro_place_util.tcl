if { [find_macros] != "" } {
  ...
  if { [env_var_exists_and_non_empty RTLMP_VIRTUAL_PLACE] && \
       ([string tolower $::env(RTLMP_VIRTUAL_PLACE)] == "1" || \
        [string tolower $::env(RTLMP_VIRTUAL_PLACE)] == "true") } {
    puts "Running virtual standard-cell global placement before macro placement"
