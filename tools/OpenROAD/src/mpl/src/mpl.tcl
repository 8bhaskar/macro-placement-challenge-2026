...
sta::define_cmd_args "rtl_macro_placer_hybrid" { -max_num_macro  max_num_macro \
                                          -min_num_macro  min_num_macro \
                                          -max_num_inst   max_num_inst  \
                                          -min_num_inst   min_num_inst  \
                                          -tolerance      tolerance     \
...
proc rtl_macro_placer_hybrid { args } {
  sta::parse_key_args "rtl_macro_placer_hybrid" args \
    keys {-max_num_macro -min_num_macro -max_num_inst -min_num_inst -tolerance \
         -max_num_level -coarsening_ratio -large_net_threshold \
         -halo_width -halo_height \
         -fence_lx -fence_ly -fence_ux -fence_uy \
  ...
  if { [info exists keys(-hybrid_iterations)] } {
    set hybrid_iterations $keys(-hybrid_iterations)
  }
  ...
  if {
    ![mpl::rtl_macro_placer_hybrid_cmd $max_num_macro \
      $min_num_macro \
      $max_num_inst \
      $min_num_inst \
      $tolerance \
