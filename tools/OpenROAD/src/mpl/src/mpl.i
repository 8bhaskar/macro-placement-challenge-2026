...
bool rtl_macro_placer_hybrid_cmd(const int max_num_macro,
                                 const int min_num_macro,
                                 const int max_num_inst,
                                 const int min_num_inst,
                                 const float tolerance,
  ...
  odb::Rect global_fence = odb::Rect(block->micronsToDbu(fence_lx),
                                    ...
                                    block->micronsToDbu(fence_ux),
                                    block->micronsToDbu(fence_uy));
  const int halo_w = block->micronsToDbu(halo_width);
  const int halo_h = block->micronsToDbu(halo_height);

  if (tahpp_mode) {
    return macro_placer->placeTahpp(num_threads,
                                    max_num_macro,
                                    min_num_macro,
                                    max_num_inst,
                                    min_num_inst,
  ...
  return macro_placer->placeHybrid(num_threads,
                                  max_num_macro,
                                  min_num_macro,
                                  max_num_inst,
                                  min_num_inst,
